...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
    ...
    <form action="/leskurbas/addplay" method="post" name="addPlayForm" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input name="name" required type="text" class="form-control" id="inputName" placeholder="Enter name" maxlength="30" minlength="1">
        </div>
        <div class="form-group">
            <label for="playTime">
                Duration
            </label>
            <input name="time" type="time" required id="playTime" min="00:15" max="3:00">
            <small id="timeHelp" class="form-text text-muted">
                The play can't be longer than 3 hours.
            </small>
        </div>
        <div class="form-group">
            <label for="inputFile">
            ...
            <input name="image" required type="file" class="form-control" id="inputFile">
        </div>
